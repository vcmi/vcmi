...
#include "BAI/v15/graph/edges/hex_becomes_shoot_target_after_action_v15.h"
#include "BAI/v15/graph/edges/unit_becomes_shoot_target_after_action_v15.h"
...
#include "BAI/v15/enum_flags_v15.h"
#include "BAI/v15/graph/edge_store_v15.h"
...
#include "BAI/v15/graph/edges/unit_becomes_shoot_threat_after_action_v15.h"
#include "BAI/v15/graph/edges/unit_melee_dmg_unit_v15.h"
#include "BAI/v15/graph/edges/unit_shoot_dmg_unit_v15.h"
#include "BAI/v15/graph/node_store_v15.h"
#include "BAI/v15/graph/nodes/action_v15.h"
#include "BAI/v15/graph/nodes/global_v15.h"
...
private:
	...
	decltype(auto) withNodeStore(ET t, F && f) const
	{
		switch(t)
		{
			...
			default:
				throwf("Unexpected node element type: %1%", std::to_string(EU(t)));
		}
	}
	...
	decltype(auto) withEdgeStore(ET t, F && f) const
	{
		switch(t) // NOSONAR
		{
			...
			default:
				throwf("Unexpected edge element type: %1%", EI(t));
		}
