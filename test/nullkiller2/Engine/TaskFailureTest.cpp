...
{
	EXPECT_EQ(
		NK2AI::chooseTaskFailureAction(false, true),
...
{
	EXPECT_EQ(
		NK2AI::chooseTaskFailureAction(true, true),
...
{
	EXPECT_EQ(
		NK2AI::chooseTaskFailureAction(true, false),
		NK2AI::TaskFailureAction::REPLAN);
}
...
{
	EXPECT_EQ(
		NK2AI::chooseTaskFailureAction(false, false),
