...
void CampaignRegionsHandler::loadObject(const std::string & scope, const std::string & name, const JsonNode & data)
{
...
void CampaignRegionsHandler::loadObject(const std::string & scope, const std::string & name, const JsonNode & data, size_t index)
{
