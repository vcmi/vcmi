...
const std::vector<GameSettings::SettingOption> GameSettings::settingProperties = {
		...
		{EGameSettings::MAP_OBJECTS_REVEAL_HIDDEN_REWARDS,               "mapObjects","revealHiddenRewards"                  },
		...
		{EGameSettings::TOWNS_REVEAL_MAGE_GUILD_SPELLS,                   "towns",     "revealMageGuildSpells"                },
