...
namespace TextOperations
{
	...
	/// truncates a string to specified length, trimming characters from the right if necessary
	std::string DLL_LINKAGE truncateUnicodeString(const std::string & input, int maxLength);
