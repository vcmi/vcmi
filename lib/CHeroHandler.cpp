...
std::vector<SHexField> CObstacleInfo::getBlocked(SHexField hex) const
{
...
SHexField CObstacleInfo::getMaxBlocked(SHexField hex) const
{
	std::vector<SHexField> blocked = getBlocked(hex);
