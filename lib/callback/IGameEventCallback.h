...
public:
	...
	virtual void addScenarioEventJournalEntry(const PlayerColor & player, const std::string & title, const MetaString & message, const int3 & location, const ResourceSet & resources) = 0;
