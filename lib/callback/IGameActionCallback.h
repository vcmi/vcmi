...
public:
	...
	virtual bool enqueueBuilding(const CGTownInstance *town, BuildingID buildingID)=0;
	virtual bool dequeueBuilding(const CGTownInstance *town, BuildingID buildingID)=0;
