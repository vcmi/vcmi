...
public:
	...
	bool isAccessibleFromSomewhere(std::shared_ptr<const ObjectTemplate> appearance, const int3 & tile) const;
	int3 getAccessibleOffset(std::shared_ptr<const ObjectTemplate> appearance, const int3 & tile) const;
...
private:
	...
	bool canObstacleBePlacedHere(std::shared_ptr<const ObjectTemplate> temp, int3 &pos);
