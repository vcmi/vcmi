...
CRmgTemplateZone::CTownInfo::CTownInfo()
	: townCount(0), castleCount(0), townDensity(0), castleDensity(0)
{
...
CTileInfo::CTileInfo()
	: nearestObjectDistance(INT_MAX), terrain(ETerrainType::WRONG), roadType(ERoadType::NO_ROAD)
{
...
CRmgTemplateZone::CRmgTemplateZone()
	: id(0), type(ETemplateZoneType::PLAYER_START), owner(boost::none), size(1), townsAreSameType(false), matchTerrainToTown(true), townType(ETownType::NEUTRAL), terrainType(ETerrainType::GRASS), zoneMonsterStrength(EMonsterStrength::ZONE_NORMAL), minGuardedValue(0), questArtZone(nullptr)
{
...
std::set<ETerrainType> CRmgTemplateZone::getDefaultTerrainTypes() const
{
	...
	static const ETerrainType::EETerrainType allowedTerTypes[] =
	{
		ETerrainType::DIRT, ETerrainType::SAND, ETerrainType::GRASS, ETerrainType::SNOW,
