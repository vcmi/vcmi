...
public:
	...
	virtual EPathfindingLayer getBoatLayer() const = 0; //pathfinding layer that should be used to check boat placement
	virtual int3 bestLocation() const; //returns location where the boat should be placed
