...
public:
	...
	/// Worth of this army in combat, estimated from creature stats and abilities rather than
	/// read from the AI value that creature configuration declares
	ui64 estimateCombatValue(int fortLevel = 0) const;
