...
<context>
    ...
    <message>
        ...
        <translation>你想放弃更改吗？</translation>
    </message>
    <message>
...
<context>
    ...
    <message numerus="yes">
        <location filename="../startGame/StartGameTab.cpp" line="177"/>
...
%n/%1 已安装</numerusform>
    ...
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="235"/>
        <source>Maps</source>
        <translation>地图</translation>
    </message>
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="236"/>
        <source>Campaigns</source>
        <translation>战役</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="287"/>
 ...
 - VCMI配置文件(.json)
    ...
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="312"/>
    ...
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="322"/>
...
要导入英雄无敌历代记，请下载您希望安装的每个历代记的离线备份安装程序，选择“导入文件”选项并选择已下载的文件。这将生成并安装一个包含已导入的历代记的VCMI模组</translation>
    ...
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="347"/>
...
要解决此问题，请手动将英雄无敌3的VIDEO.VID文件复制到VCMI的数据文件目录，或重新安装VCMI并重新导入英雄无敌3的数据文件</translation>
    ...
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="369"/>
...
要解决此问题，请重新安装游戏并使用支持的英雄无敌3版本重新导入数据文件。VCMI需要英雄无敌3：死亡阴影或完全版才能运行，您可以（例如）从gog.com获取</translation>
    ...
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="380"/>
...
要解决此问题，请手动将缺失的英雄无敌3数据文件复制到VCMI的数据文件目录，或重新安装VCMI并重新导入英雄无敌3的数据文件</translation>
    ...
    <message>
        <location filename="../startGame/StartGameTab.cpp" line="459"/>
