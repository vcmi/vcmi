...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Αποθήκευση αρχείων καταγραφής</translation>
    </message>
    <message>
        <location filename="../aboutProject/aboutproject_moc.cpp" line="442"/>
    ...
    <message>
        ...
        <translation type="obsolete">Αποστολή αρχείων καταγραφής</translation>
    </message>
    <message>
        <source>The archive will be sent via another application. Share your logs e.g. over discord to developers.</source>
        <translation type="obsolete">Το αρχείο θα αποσταλεί μέσω άλλης εφαρμογής. Μοιραστείτε τα αρχεία καταγραφής σας π.χ. μέσω Discord με τους προγραμματιστές.</translation>
    </message>
    <message>
        <location filename="../aboutProject/aboutproject_moc.cpp" line="411"/>
        <location filename="../aboutProject/aboutproject_moc.cpp" line="448"/>
...
Αποκλειστική Πλήρης Οθόνη - το παιχνίδι θα καλύπτει όλη την οθόνη και θα χρησιμοποιεί την επιλεγμένη ανάλυση.</translation>
    ...
    <message>
        ...
        <translation type="obsolete">Όριο αυτόματης αποθήκευσης (0 = απενεργοποιημένο)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Πρόθεμα αυτόματης αποθήκευσης</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">κενό = πρόθεμα ονόματος χάρτη</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Εγκατάσταση συμβατής έκδοσης του &quot;Horn of the Abyss&quot;, fan-made επέκταση του Heroes III που μεταφέρθηκε από την ομάδα του VCMI</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Εγκατάσταση συμβατής έκδοσης του &quot;In The Wake of Gods&quot;, fan-made επέκταση του Heroes III</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Εγκατάσταση mod με διάφορες βελτιώσεις διεπαφής, όπως καλύτερη διεπαφή για τυχαίους χάρτες και επιλέξιμες ενέργειες στις μάχες</translation>
    </message>
    <message>
...
%n/%1 εγκατεστημένα</numerusform>
    ...
    <message>
        ...
        <translation type="obsolete">Επιλέξτε αρχεία (ρυθμίσεις, mods, χάρτες, εκστρατείες, αρχεία gog) για εγκατάσταση...</translation>
    </message>
    <message>
 ...
 - VCMI configuration files (.json)
        ...
        <translation type="obsolete">Αυτή η επιλογή επιτρέπει την εισαγωγή επιπλέον αρχείων δεδομένων στην εγκατάστασή σου VCMI. Προς το παρόν υποστηρίζονται οι ακόλουθες επιλογές:
