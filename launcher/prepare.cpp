...
void prepareAndroid()
{
	...
	QAndroidJniObject::callStaticObjectMethod("org/libsdl/app/SDL", "setupJNI", "(V)Lorg/libsdl/app/SDL;");
	QAndroidJniObject::callStaticObjectMethod("org/libsdl/app/SDL", "initialize", "(V)Lorg/libsdl/app/SDL;");
}
}
#endif
