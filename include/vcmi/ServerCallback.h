...
public:
	...
	/// Rolls a chance-based combat ability of the given unit. Uses the per-army biased sequence
	/// rather than the plain RNG, so results match H3 - do not reimplement this with getRNG().
