...
void BattleHexProxy::registerMethods(MethodRegistrar & R)
{
	...
	R.method<&BattleHex::getX>               ("getX", {}, "Returns the column of this hex, counting from 0 at the left edge of the battlefield.");
	R.method<&BattleHex::getY>               ("getY", {}, "Returns the row of this hex, counting from 0 at the top of the battlefield. Odd rows are shifted half a hex to the right.");
}
