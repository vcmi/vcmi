...
It is also possible to play the Heroes Chronicles with VCMI. You still need a completely installed VCMI (with heroes 3 sod / complete files).
...
For each chapter you will need a separate exe file to install (if you want to install all, you'll need 8 exe files).
