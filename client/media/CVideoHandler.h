...
{
	void getVideoAndBackgroundRects(const std::string & name, const Point & position, SDL_Rect & video, SDL_Rect & RectbackgroundRect, const Point preferredLogicalResolution) const;
