...
void UnitActionPanel::setPossibleActions(const std::vector<PossiblePlayerBattleAction> & newActions)
{
	...
	static const std::vector actionsAttackNoLongWeapon = { PossiblePlayerBattleAction::ATTACK_WITHOUT_LONG_WEAPON, PossiblePlayerBattleAction::WALK_AND_ATTACK };
	...
	testAndAddAction(newActions, actionsAttackNoLongWeapon, ImagePath::builtin("battle/actionNoLongWeapon"), "vcmi.battle.action.attackNoLongWeapon");
